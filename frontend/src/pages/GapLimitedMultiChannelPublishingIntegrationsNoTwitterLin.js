...
/**
 * Gap/CFS Feature Page: Limited multi-channel publishing integrations — no Twitter/LinkedIn/Instagram/Medium/Substack adapters.
 * Slug: limited-multi-channel-publishing-integrations-no-twitter-lin
 * Backend: /api/gap-limited-multi-channel-publishing-integrations-no-twitter-lin
 */
export default function LimitedMultiChannelPublishingIntegrationsNoTwitterLinPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-multi-channel-publishing-integrations-no-twitter-lin', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Limited multi-channel publishing integrations — no Twitter/LinkedIn/Instagram/Medium/Substack adapters.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Limited multi-channel publishing integrations — no Twitter/LinkedIn/Instagram/Medium/Substack adapters.</p>
