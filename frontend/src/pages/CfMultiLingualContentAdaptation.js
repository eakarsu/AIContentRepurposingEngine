...
/**
 * Gap/CFS Feature Page: Multi-lingual content adaptation
 * Slug: multi-lingual-content-adaptation
 * Backend: /api/cf-multi-lingual-content-adaptation
 */
export default function MultiLingualContentAdaptationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-multi-lingual-content-adaptation', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Multi-lingual content adaptation</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Localize content for regional markets (not just translation, but cultural adaptation).</p>
