...
/**
 * Gap/CFS Feature Page: Missing `/extract-key-points`, `/generate-thumbnail`, `/suggest-hashtags`, `/detect-trending-topics`.
 * Slug: missing-extract-key-points-generate-thumbnail-suggest-hashta
 * Backend: /api/gap-missing-extract-key-points-generate-thumbnail-suggest-hashta
 */
export default function MissingExtractKeyPointsGenerateThumbnailSuggestHashtaPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-missing-extract-key-points-generate-thumbnail-suggest-hashta', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Missing `/extract-key-points`, `/generate-thumbnail`, `/suggest-hashtags`, `/detect-trending-topics`.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Missing `/extract-key-points`, `/generate-thumbnail`, `/suggest-hashtags`, `/detect-trending-topics`.</p>
