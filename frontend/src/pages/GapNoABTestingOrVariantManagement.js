...
/**
 * Gap/CFS Feature Page: No A/B testing or variant management.
 * Slug: no-a-b-testing-or-variant-management
 * Backend: /api/gap-no-a-b-testing-or-variant-management
 */
export default function NoABTestingOrVariantManagementPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-a-b-testing-or-variant-management', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No A/B testing or variant management.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No A/B testing or variant management.</p>
