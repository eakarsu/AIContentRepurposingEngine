...
/**
 * Gap/CFS Feature Page: Agentic content expansion
 * Slug: agentic-content-expansion
 * Backend: /api/cf-agentic-content-expansion
 */
export default function AgenticContentExpansionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-content-expansion', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Agentic content expansion</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Take one seed article; auto-generate blog, 5 social posts, email newsletter, YouTube script, podcast outline—all coordinated voice.</p>
