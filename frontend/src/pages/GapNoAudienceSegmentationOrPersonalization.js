...
/**
 * Gap/CFS Feature Page: No audience segmentation or personalization.
 * Slug: no-audience-segmentation-or-personalization
 * Backend: /api/gap-no-audience-segmentation-or-personalization
 */
export default function NoAudienceSegmentationOrPersonalizationPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-audience-segmentation-or-personalization', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>No audience segmentation or personalization.</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>No audience segmentation or personalization.</p>
