...
/**
 * Gap/CFS Feature Page: Engagement prediction
 * Slug: engagement-prediction
 * Backend: /api/cf-engagement-prediction
 */
export default function EngagementPredictionPage() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      const res = await fetch('/api/cf-engagement-prediction', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 900, margin: '0 auto', color: '#e5e7eb' }}>
      <h2 style={{ marginBottom: 8 }}>Engagement prediction</h2>
      <p style={{ opacity: 0.75, marginBottom: 16 }}>Predict which content will perform best before publishing; recommend modifications.</p>
